<a href="{{ $url }}" style="text-decoration: none">
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
        ...
        <g clip-path="url(#clip0_80_5701)">
            <path d="M8 10H6V8L12 2L14 4L8 10Z" stroke="#065FD4" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path d="M10.5 3.5L12.5 5.5" stroke="#065FD4" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path
                    ...
                    stroke="#065FD4" stroke-linecap="round" stroke-linejoin="round"/>
        </g>
        <defs>
            <clipPath id="clip0_80_5701">
